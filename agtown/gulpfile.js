...
gulp.task('js', ['common-js'], function() {
	return gulp.src([
		...
		'app/libs/maskedInput.js',
		// 'app/libs/fancybox-master/dist/jquery.fancybox.min.js',
		// 'app/libs/iEdit/src/iEdit.min.js',
		// 'app/libs/jquery.uploadPreviewer.js',
...
gulp.task('fileinclude', function() {
	...
	.pipe(gulp.dest('app/'));
	gulp.src(['app/include/category.html'])
	.pipe(fileinclude({
		prefix: '@@',
		basepath: '@file'
	}))
	.pipe(concat('category.html'))
	.pipe(gulp.dest('app/'));
	...
	.pipe(concat('lk.html'))
	.pipe(gulp.dest('app/'));
	gulp.src(['app/include/single-company.html'])
	.pipe(fileinclude({
		prefix: '@@',
		basepath: '@file'
	}))
	.pipe(concat('single-company.html'))
	.pipe(gulp.dest('app/'));
	gulp.src(['app/include/contact.html'])
	.pipe(fileinclude({
		prefix: '@@',
		basepath: '@file'
	}))
	...
	.pipe(gulp.dest('app/'));
	gulp.src(['app/include/lk-edit.html'])
	.pipe(fileinclude({
		prefix: '@@',
		basepath: '@file'
	}))
	.pipe(concat('lk-edit.html'))
	.pipe(gulp.dest('app/'));
	gulp.src(['app/include/add-single.html'])
	.pipe(fileinclude({
		prefix: '@@',
		basepath: '@file'
	}))
	.pipe(concat('add-single.html'))
	.pipe(gulp.dest('app/'));
});
