...
gulp.task('js', ['common-js'], function() {
	return gulp.src([
		...
		'app/libs/fontawesome-free-5.0.13/svg-with-js/js/fa-solid.min.js',
		'app/libs/fontawesome-free-5.0.13/svg-with-js/js/fontawesome.min.js',
...
gulp.task('fileinclude', function() {
	...
	.pipe(gulp.dest('app/'));
	gulp.src(['app/include/singular.html'])
	.pipe(fileinclude({
		prefix: '@@',
		basepath: '@file'
	}))
	.pipe(concat('singular.html'))
	.pipe(gulp.dest('app/'));
});
