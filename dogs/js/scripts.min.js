...
// Корзина
  var d = document,
    itemBox = d.querySelectorAll('.const-form .form'), // блок каждого товара
    cartCont = d.getElementById('cartContent'); // блок вывода данных корзины
...
function addToCart(e){
  ...
  var cartData = getCartData() || {}, // получаем данные корзины или создаём новый объект, если данных еще нет
      ...
      itemId = parentBox.querySelector('.slider-nav-item').getAttribute('data-id'), // ID товара
      itemImg = parentBox.querySelector('.slider-nav-item img').getAttribute('href'),
