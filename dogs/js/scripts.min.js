...
//   totalItems = '';
//   if(cartData !== null){
//     totalItems = '<table class=""><tr><th>Наименование</th><th>Цена</th><th>Кол-во</th></tr>';
...
//   return false;
// }
//   $('.order button').click(addToCart);
// });

// $('.order button').click(function(){
//   design = $('.slider-nav .slick-current img').attr('src');
//   arom = $('#arom option:selected').val();
//   $('#cartContent').prepend("<li><input id='check' name='check' type='checkbox'/>" + design + arom + "</li>");
//   cartData = $('#cartContent').html();
//   localStorage.setItem('cartData', cartData);
//   return false;
//   if (localStorage.getItem('cartData')) {
//     $('#cartContent').html(localStorage.getItem('cartData'));
//   }
// });
