...
$('.contacts__logos__slider').slick({
 ...
 $('.product__photo__slider').slick({
  slidesToShow: 1,
  slidesToScroll: 1,
  arrows: false,
  fade: false,
  vertical: true,
  asNavFor: '.product__photo__slider__nav'
});
$('.product__photo__slider__nav').slick({
  slidesToShow: 4,
  slidesToScroll: 1,
  asNavFor: '.product__photo__slider',
  arrows: false,
  vertical: true,
  centerMode: true,
  focusOnSelect: true
