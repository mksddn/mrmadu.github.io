...
$(function() {
  ...
  if($(window).width() < 992) {
    $( '.menu-toggle, .nav_menu li a' ).click( function() {
     if ( $( '.nav_menu' ).is( ':hidden' ) ) {
      $( '.nav_menu' ).show('slideDown');
    } else {
      $( '.nav_menu' ).hide('slideUp');
    }
  });
  };

  $('.nav_menu ul>li:nth-child(4)>a, .nav_menu ul>li:nth-child(5)>a').attr('class','popup');
