...
$(function(){function e(e){e<0&&(e=0);var i=Math.floor(e/60/60/24),t=Math.floor(e/60/60),o=Math.floor((e-60*t*60)/60),n=Math.floor(e-60*t*60-60*o),a=Math.floor((e-24*i*60*60)/60/60);$(".cta__info__counter__item .days").text(i),$(".cta__info__counter__item .hours").text(a),String(o).length>1?$(".cta__info__counter__item .mins").text(o):$(".cta__info__counter__item .mins").text("0"+o),String(n).length>1?$(".cta__info__counter__item .secs").text(n):$(".cta__info__counter__item .secs").text("0"+n)}if($(window).width()>480)var i=80,o=0;if($(window).width()<480)var i=0,o=0;$(function(){var e=$(".header__nav"),t=$(this).scrollTop();t>i&&e.css("top",o),$(window).scroll(function(){(t=$(this).scrollTop())+o<i?e.css("top",i-t):e.css("top",o)})}),$(".header__nav__menu li").click(function(){$("li>ul").is(":hidden")?$("li>ul").slideDown("slow").css("display","flex"):$("li>ul").slideUp("fast")}),t=$("html");var n=$("#menu").mmenu({extensions:{all:["theme-white","fx-menu-slide","pagedim-black"]},navbar:{title:"Tesla"},pageScroll:{scroll:!0,update:!0,scrollOffset:300}}).data("mmenu"),a=$("#hamburger").on("click",function(e){e.preventDefault(),t.hasClass("mm-opened")?n.close():n.open()}).children(".hamburger");n.bind("close:finish",function(){setTimeout(function(){a.removeClass("is-active")},100)}),n.bind("open:finish",function(){setTimeout(function(){a.addClass("is-active")},100)}),$(".blue .main__item__figure").hover(function(){$(".main__item__decor").addClass("when_triangle_hover")},function(){$(".main__item__decor").removeClass("when_triangle_hover")}),$(".yellow .main__item__figure").hover(function(){$(".main__item__decor").addClass("when_circle_hover")},function(){$(".main__item__decor").removeClass("when_circle_hover")}),$(".purple .main__item__figure").hover(function(){$(".main__item__decor").addClass("when_square_hover")},function(){$(".main__item__decor").removeClass("when_square_hover")});var s=$(".portfolio__items");$(".portfolio__category li").click(function(){var e=$(this);e.hasClass("is-checked")||(e.parents(".portfolio__items").find(".is-checked").removeClass("is-checked"),e.addClass("is-checked"));var i=e.attr("data-filter");return s.isotope({itemSelector:".portfolio__item",filter:i}),!1});var r=80768;$(document).ready(function(){setInterval(function(){e(r-=1),r<=0&&alert("Акция закончилась!")},1e3)}),$(".feedback__items").slick({autoplay:!0,autoplaySpeed:5e3,infinite:!0,speed:300,slidesToShow:1,adaptiveHeight:!0,prevArrow:'<div class="feedback__items__arrow prev"></div>',nextArrow:'<div class="feedback__items__arrow next"></div>'}),$(".team__items").slick({infinite:!0,speed:300,slidesToShow:3,adaptiveHeight:!0,prevArrow:'<div class="feedback__items__arrow prev"></div>',nextArrow:'<div class="feedback__items__arrow next"></div>',responsive:[{breakpoint:1024,settings:{slidesToShow:3}},{breakpoint:600,settings:{slidesToShow:2}},{breakpoint:480,settings:{slidesToShow:1}}]}),$(document).ready(function(){$(".upgrade__content").magnificPopup({delegate:"a",type:"image",closeOnContentClick:!1,closeBtnInside:!1,mainClass:"mfp-with-zoom mfp-img-mobile",image:{verticalFit:!0},gallery:{enabled:!0},zoom:{enabled:!0,duration:300,opener:function(e){return e.find("img")}}}),$(".popup_callback").magnificPopup({type:"inline",fixedContentPos:!1,fixedBgPos:!0,overflowY:"auto",closeBtnInside:!0,preloader:!1,midClick:!0,removalDelay:300,mainClass:"my-mfp-zoom-in"})}),$("#accordion").accordionjs({activeIndex:1,closeAble:!1,closeOther:!0,slideSpeed:200})}),$(document).ready(function(){$("form").submit(function(){var e=$(this);return $.ajax({type:"POST",url:"../../mail.php",data:e.serialize()}).done(function(){alert("Скоро мы свяжемся с вами!"),setTimeout(function(){e.trigger("reset")},1e3)}),!1})});