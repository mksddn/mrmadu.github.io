...
$(document).ready(function(){$(function(){var e=$(".header__menu"),i=$(this).scrollTop();i>160&&e.css("top",0),$(window).scroll(function(){(i=$(this).scrollTop())+0<160?e.css("top",160-i):e.css("top",0)})}),document.documentElement.clientWidth<767&&$(".header__menu i, .header__menu li a").click(function(){$(".header__menu nav").is(":hidden")?$(".header__menu nav").show():$(".header__menu nav").hide()}),$(".business .last_news__items__slider").slick({autoplay:!0,autoplaySpeed:5e3,infinite:!0,fade:!0,prevArrow:'<i class="fa fa-angle-left"></i>',nextArrow:'<i class="fa fa-angle-right"></i>'}),$(".people .last_news__items__slider").slick({slidesToShow:3,slidesToScroll:1,infinite:!0,prevArrow:'<i class="fa fa-angle-left"></i>',nextArrow:'<i class="fa fa-angle-right"></i>'}),$(".news .last_news__items__slider").slick({slidesToShow:1,infinite:!0,prevArrow:'<i class="fa fa-angle-left"></i>',nextArrow:'<i class="fa fa-angle-right"></i>'}),$(".home .last_news__items").masonry({itemSelector:".home .last_news__item",columnWidth:10})});